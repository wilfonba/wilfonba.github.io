...
\textbf{GitHub:} \href{https://github.com/wilfonba}{\texttt{github.com/wilfonba}} \\
...
\begin{itemize}
    \item (2024-Present) Association for Computing Machinery (ACM), Member
    \item (2024-Present) American Physical Society (APS), Member
\end{itemize}

\section{Service and Outreach}
\begin{itemize}
    \item (2023-Present) Presidents undergraduate research award reviewer
    \item (2023-Present) CSE Graduate Student Association vice-president
    \item (2022-23) CSE Graduate Student Association events officer
    \end{itemize}
