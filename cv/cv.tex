...
\fancyfoot[C]{\transparent{0.4}{Latest at \href{https://benwilfong.com/res/CV.pdf}{\texttt{benwilfong.com/res/CV.pdf}}}}
...
\begin{etaremune}[label={[P\reversearabic*]}]
    \item \fullcite{RADHAKRISHNAN2024}
\end{etaremune}

\subsection{Conference papers}

\begin{etaremune}[label={[C\reversearabic*]}]
    \item \fullcite{wilfong2024AIAA}
    \item \fullcite{wilfong2024ICNMMF}
\end{etaremune}
